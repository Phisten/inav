...
/** OTHER HARDWARE **/
    ...
    BUSDEV_REGISTER_I2C(busdev_ug2864,      DEVHW_UG2864,       UG2864_I2C_BUS,     0x3C,               NONE,           DEVFLAGS_NONE);
        ...
        BUSDEV_REGISTER_SPI(busdev_pmw3901,     DEVHW_PMW3901,      PMW3901_SPI_BUS,    PMW3901_CS_PIN,     NONE,   DEVFLAGS_USE_MANUAL_DEVICE_SELECT | DEVFLAGS_USE_RAW_REGISTERS);
        //BUSDEV_REGISTER_SPI(busdev_pmw3901,     DEVHW_PMW3901,      PMW3901_SPI_BUS,    PMW3901_CS_PIN,     NONE,   DEVFLAGS_USE_RAW_REGISTERS);
    #endif
#endif
